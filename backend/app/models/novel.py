...
from sqlalchemy import String, Enum, Integer, Float, Text, DateTime, Uuid
...
class Novel(Base):
    ...
    status: Mapped[NovelStatus] = mapped_column(Enum(NovelStatus, native_enum=False), default=NovelStatus.ongoing, nullable=False)
